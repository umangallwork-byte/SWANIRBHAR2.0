        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {stories.map((story, idx) => (
            <motion.div
              ...
              className="bg-[#F7F7F2]/60 backdrop-blur-xl border border-white/80 shadow-[8px_8px_16px_#e3e3de,-8px_-8px_16px_#ffffff] rounded-3xl p-10 flex flex-col items-start transition-transform hover:-translate-y-2 duration-300 h-full"
            >
