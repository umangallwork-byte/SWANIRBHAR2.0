        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 w-full">
          {impacts.map((metric, idx) => (
            <motion.div 
              ...
              className="w-full bg-[#FFFFFF]/60 backdrop-blur-xl border-2 border-black shadow-[8px_8px_0px_#000000] rounded-3xl p-8 flex flex-col text-left group hover:-translate-y-2 transition-transform duration-300"
            >
